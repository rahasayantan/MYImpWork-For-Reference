...
for i in [0, .1, .5, 2, 5, 10, 15, 20]:
    for seed in [2017]:
        ...
        for dev_index, val_index in kf.split(train):
            ...
            et = Ridge(alpha=i, fit_intercept=True, normalize=True, max_iter=3000, tol=0.00001)
...
######################################################
joblib.dump(oobpred2,'../input/train_lasso_withoutlier.pkl')
joblib.dump(pred2,'../input/test_lasso_withoutlier.pkl')
